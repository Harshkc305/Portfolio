  ...
  const testimonials = [
    {
      ...
      content: "Harsh demonstrated exceptional understanding of the full-stack lifecycle. His implementation of Redis caching to cut database load in the Doctor Management System was remarkably efficient.",
      image: "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=150"
    },
    {
      name: "David Chen",
      role: "Senior Engineering Consultant",
      content: "Harsh has an outstanding grip on modern React, Redux, and Node.js. His ability to structure clean MVC codebases and secure them with JWT and input validation is impressive.",
      image: "https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg?auto=compress&cs=tinysrgb&w=150"
    },
    {
      name: "Maria Rodriguez",
      role: "Project Coordinator",
      content: "Delivered complex full-stack features reliably and ahead of schedule. His attention to detail regarding MongoDB Aggregation pipelines and Razorpay integration is top-notch.",
    ...
    <section id="testimonials" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">
          Peer &amp; Mentor <span className="text-gradient-primary">Testimonials</span>
        </h2>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Feedback and recommendations from mentors and peers I've collaborated with on software projects.
        </p>
      </motion.div>
