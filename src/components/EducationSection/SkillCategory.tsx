...
export default function ProfessionalProfile() {
  const technicalSkills = [
    { name: "React.js & Redux Toolkit", level: 92, icon: Atom, color: "text-cyan-400" },
    { name: "Node.js & Express.js", level: 90, icon: Server, color: "text-emerald-400" },
    { name: "JavaScript (ES6+) & TypeScript", level: 90, icon: Code2, color: "text-blue-400" },
    { name: "MongoDB & Aggregation", level: 88, icon: Database, color: "text-amber-400" },
    { name: "Redis Caching & REST APIs", level: 85, icon: Cloud, color: "text-purple-400" },
  ];

  const softSkills = [
    { name: "Leadership (IIM-A)", icon: Crown, color: "text-amber-400 border-amber-500/30 bg-amber-500/10" },
    { name: "Problem Solving", icon: Brain, color: "text-purple-400 border-purple-500/30 bg-purple-500/10" },
    { name: "Agile & SDLC", icon: Workflow, color: "text-sky-400 border-sky-500/30 bg-sky-500/10" },
    { name: "Full-Stack Architecture", icon: Rocket, color: "text-rose-400 border-rose-500/30 bg-rose-500/10" },
    { name: "API & Payment Integration", icon: Lightbulb, color: "text-yellow-400 border-yellow-500/30 bg-yellow-500/10" },
    { name: "Clean Code & Security", icon: Users, color: "text-emerald-400 border-emerald-500/30 bg-emerald-500/10" },
  ];
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-r from-primary/10 via-purple-500/5 to-transparent border border-primary/20 flex items-start gap-3.5 shadow-sm">
              ...
              <div>
                <strong className="text-foreground font-bold text-sm block mb-0.5">
                  Constant Learner & Dedicated Engineer
                </strong>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Passionate about mastering modern web technologies, building scalable cloud-native architectures, and delivering clean, maintainable code.
                </p>
              </div>
            </div>
          </div>
