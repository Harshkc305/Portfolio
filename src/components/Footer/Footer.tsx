...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Harshkc305", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/harshkc305", label: "LinkedIn" },
    { icon: Mail, href: "mailto:harshkc305@gmail.com", label: "Email" },
    { icon: Phone, href: "tel:+918789106615", label: "Phone" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 flex flex-col gap-10">
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 rounded-xl bg-gradient-to-tr from-purple-600 via-primary to-sky-400 p-[1px] shadow-lg">
              <div className="w-full h-full bg-background rounded-[11px] flex items-center justify-center">
                <span className="font-extrabold text-[11px] tracking-tight bg-gradient-to-r from-purple-500 to-sky-400 bg-clip-text text-transparent">
                  HKC
                </span>
              </div>
            </div>
        ...
        <div className="pt-6 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5 font-medium text-center md:text-right">
            <span>© {new Date().getFullYear()} Harsh Kumar Choudhary. Crafted with</span>
