...
const services = [
  {
    ...
    description: "End-to-end responsive web applications engineered with React.js, Redux Toolkit, Node.js, Express, and modern styling libraries.",
  },
  {
    icon: Server,
    title: "RESTful API & Backend Systems",
    description: "Clean MVC architectures, secure JWT & Bcrypt authentication, Joi input validation, and role-based permissions designed for high availability.",
  },
  {
    icon: Database,
    title: "Database Optimization & Caching",
    description: "High-performance data modeling with MongoDB Aggregation Framework and Redis in-memory caching to slash database latency by up to 60%.",
  },
  {
    icon: CreditCard,
    title: "Payment & Cloud Integrations",
    description: "Seamless Razorpay payment gateway integration, automated transactional emails with Nodemailer, and Cloudinary media processing pipelines.",
  }
];
    ...
    <section id="services" className="max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          Delivering robust full-stack solutions across the entire lifecycle of modern web engineering.
        </p>
      </motion.div>
