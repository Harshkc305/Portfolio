      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full flex-1 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-20 pb-12">
        ...
        >
          <motion.div 
            ...
            className="mb-6 flex flex-wrap items-center justify-center md:justify-start gap-3"
          >
            ...
            <Badge variant="outline" size="lg" className="gap-2 py-1.5 px-4 glass-panel border-purple-500/30 bg-purple-500/10 text-primary font-semibold text-xs">
              <Sparkles className="w-3.5 h-3.5 text-primary" />
              <span>Google Gemini: "Fund My Crazy" Participant</span>
            </Badge>
          </motion.div>
          ...
          >
            Full Stack Developer specializing in the MERN Stack. Building high-performance, scalable web applications with Redis caching, MongoDB Aggregation, and clean architecture.
          </motion.p>
          ...
          >
            ...
            <a 
              href="/Harsh_Kumar_Choudhary_Resume.pdf" 
              download="Harsh_Kumar_Choudhary_Resume.pdf"
              target="_blank"
          ...
          >
            {[
              { Icon: Github, href: "https://github.com/Harshkc305", title: "GitHub" },
              { Icon: Linkedin, href: "https://linkedin.com/in/harshkc305", title: "LinkedIn" },
              { Icon: Mail, href: "mailto:harshkc305@gmail.com", title: "Email" },
              { Icon: Phone, href: "tel:+918789106615", title: "Phone" },
            ...
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="relative px-5 pt-7 pb-6 flex flex-col items-center bg-gradient-to-br from-purple-700 via-primary to-indigo-950 text-white overflow-hidden">
                ...
                <div className="mt-1 relative w-28 h-28 rounded-full p-1 bg-gradient-to-tr from-cyan-400 via-primary to-purple-400 backdrop-blur-md shadow-2xl border border-white/50 overflow-hidden group">
                  <img 
                    src="/harsh.jpg" 
                    alt="Harsh Kumar Choudhary" 
                    className="w-full h-full object-cover object-center rounded-full filter contrast-105"
                    loading="eager"
                  />
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">Harsh Kumar Choudhary</h3>
