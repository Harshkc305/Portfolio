  ...
  const projects = [
    {
      ...
      subtitle: "Full-Stack MERN healthcare system with Redis caching (~60% DB load reduction), Razorpay & MongoDB aggregation",
      link: "https://github.com/Harshkc305",
    ...
    },
    {
      ...
      subtitle: "Full-stack event booking engine following strict SDLC methodology, Razorpay checkout & automated email alerts",
      link: "https://github.com/Harshkc305",
    ...
    },
    {
      ...
      subtitle: "Responsive shopping application with Redux Toolkit state management, secure auth & complete product/order CRUD",
      link: "https://github.com/Harshkc305",
    ...
    {
      id: 4,
      title: "Spotify Music Player Web UI",
      subtitle: "Interactive web music player replicating modern audio controls, dynamic album art, and responsive sidebar",
      link: "https://github.com/Harshkc305",
    ...
    <section id="projects" className="w-full max-w-7xl mx-auto px-6 py-24">
      ...
      >
        ...
        <p className="text-muted-foreground text-center md:text-left max-w-2xl text-lg">
          A showcase of scalable full-stack applications, robust backend architectures, and modern web systems I've engineered.
        </p>
      </motion.div>
